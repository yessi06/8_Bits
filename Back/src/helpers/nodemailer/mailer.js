    ...
    async function sendMailResetPassword(email, token){
        ...
        const mailOptions={
            ...
            <body>
                ...
                <div class="content">
                    <p>Dear User,</p>
                    <p>We ${token} received a request to reset your password for your 8 Bits account. If you made this request, please follow the instructions below to reset your password:</p>
